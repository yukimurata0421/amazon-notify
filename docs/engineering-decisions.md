...
## 29. `pubsub_idle_trigger_interval_seconds` で idle catch-up を常設した理由
...
## 30. main 健康監視 timer で `amazon-notify-pubsub.service` 再起動を自動化した理由
...
## 31. Gmail watch の日次再登録 timer を標準運用にした理由
