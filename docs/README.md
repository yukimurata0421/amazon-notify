...
このディレクトリの一次導線です。運用時はまず `HYBRID_QUICKSTART` と `OPERATIONS` を参照してください。

## セットアップ
- [HYBRID_QUICKSTART_JA.md](./HYBRID_QUICKSTART_JA.md)
- [DOCKER.md](./DOCKER.md)

## 運用
- [OPERATIONS.md](./OPERATIONS.md)
- [HYBRID_ARCHITECTURE_JA.md](./HYBRID_ARCHITECTURE_JA.md)
- [ops/INCIDENT-2026-05-04-SSL-HANDSHAKE.md](./ops/INCIDENT-2026-05-04-SSL-HANDSHAKE.md)
