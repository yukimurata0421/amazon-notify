...
### 意図
- 一時的な API/ネットワーク瞬断を毎回 pager 化しないため。
- 本当に見るべき障害（認証切れ、持続障害）を埋もれさせないため。
...
### 意図
- 実運用での warning ノイズと手動ミスを減らし、再現性を上げるため。
